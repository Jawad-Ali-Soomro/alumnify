...
const LoginForm = () => {
  ...
  return (
    <div className="flex flex-col gap-4 h-[100vh] items-center justify-center">
      <form
        className="w-[400px] px-5 py-10 relative gap-3 flex flex-col items-center align-center"
        onSubmit={handleSubmit(onSubmit)}
      >
        <img src="/alumnify-logo.png" className="w-40 top-[-100px] left-[-100px] p-2" alt="" />
        <div>
          <Input
            className={"h-10 w-90"}
            placeholder="Email"
        ...
        <a className="flex w-90 align-end justify-end text-[#1E3A8A]" href="/forgot">Forgot Password?</a>
        <Button
        ...
        <div className="flex justify-between w-90">
          ...
          <Button className={"bg-[#333] hover:bg-[#222] w-50 py-2 rounded-lg text-white h-10 uppercase font-semibold text-[14px] cursor-pointer"}>
            Register
          </Button>
        </div>
      </form>
