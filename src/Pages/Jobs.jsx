...
const Jobs = () => {
  ...
  return (
    <div className="space-y-6 mt-30 md:ml-30 mx-auto px-4">
      ...
      {filteredJobs.length === 0 ? (
        ...
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-6">
          {filteredJobs.map((job, idx) => (
            <Card key={idx} className="p-4 hover:shadow-md transition-shadow h-full">
      ...
      <div className="fixed bottom-5 right-5 w-[50px] h-[50px] bg-[#333] text-white flex justify-center items-center" onClick={() => navigate('/admin/create/job')}>
        <Plus />
      </div>
    </div>
  );
